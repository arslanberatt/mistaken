...
- **Branch:** Pending
- **Base SHA:** Pending Specs 02–03 merge
- **Implementation commit SHA:** Pending
- **Changed paths:** Pending
- **Resolved dependency versions/features/licenses:** Pending
- **macOS hardware/architecture/version:** Pending
- **macOS microphone identity and permission states:** Pending
- **Windows hardware/architecture/edition/version/build:** Pending
- **Windows microphone identity and privacy states:** Pending
- **Negotiated formats/block capacities/pool memory:** Pending
- **Real signal/block/sequence/overflow observations:** Pending
- **Real Start → Stop → Start observations and teardown timings:** Pending
- **Real disconnect/recovery observations:** Pending
- **Active-close/relaunch observations:** Pending
- **Built macOS Info.plist inspection:** Pending
...
- **Real native UI/accessibility observations:** Pending
- **Offline/privacy/no-transcript inspection:** Pending
- **Temporary artifact cleanup:** Pending
- **High-capability review findings/dispositions:** Pending

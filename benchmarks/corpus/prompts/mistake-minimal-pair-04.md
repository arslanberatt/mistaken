# mistake-minimal-pair-04

**Condition:** `mistake-minimal-pair` — Acoustically risky minimal pair
...
```text
Their house is over there past the new bridge.
```

Deliberate error spans in this prompt (for reference only, not read aloud):
- `their house` (minimal-pair)
- `over there` (minimal-pair)

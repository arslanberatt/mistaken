# mistake-preposition-07

**Condition:** `mistake-preposition` — Wrong or missing preposition
...
```text
She apologized me for being late to the meeting.
```

Deliberate error spans in this prompt (for reference only, not read aloud):
- `apologized me` (preposition)
